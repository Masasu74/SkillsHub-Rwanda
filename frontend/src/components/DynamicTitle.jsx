  ...
  useEffect(() => {
    const updateTitle = () => {
      ...
      if (loading) {
        ...
        document.title = 'SkillsHub Rwanda – Learning Platform';
        return;
      }
      
      if (settings?.companyName) {
        const newTitle = `${settings.companyName} – Learning Platform`;
        ...
        const fallbackTitle = 'SkillsHub Rwanda – Learning Platform';
